...
function quadMV(verts) --OK i may need it also wtf is it doin here idk the answer
	local t = Def.ActorMultiVertex{
...
function Triangle(verts) --OK i may need it also wtf is it doin here idk the answer
	local t = Def.ActorMultiVertex{
		InitCommand= function(self) 
